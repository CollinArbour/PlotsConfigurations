...
op_dict = json.load(open("%s/WW/FullRunII/Full2017_v9/prcsd_aC/aC/aC_wts.json"%configurations))

# Load dictionary of Zcorrection values
cors = json.load(open("%s/WW/FullRunII/Full2017_v9/prcsd_aC/aC/Zcors.json"%configurations))
